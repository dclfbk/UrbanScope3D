...
export const STRINGS = {
  ...
  // Layer labels
  layer_buildings_3d: { it: 'Edifici 3D + ombre', en: 'Buildings 3D + shadows' },
  layer_buildings_2d: { it: 'Edifici (footprint 2D)', en: 'Buildings (2D footprint)' },
  layer_buildings_temp: { it: 'Edifici → temperatura', en: 'Buildings → temperature' },
